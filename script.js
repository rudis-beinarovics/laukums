...
function trijveids() {
  ...
  if (m1 = m2 || (m1 = m3) || (m2 = m3)) {
    string = "Vienadsanu trijsturis";
  }else{
      if (m1 = m2 = m3) {
    string = "Vienadmalu trijsturis";
      
  }
 else {
    string = "Vienkars trijsturis";
    
  }
}


 if(string="Vienadsanu trijsturis"){
 v= "Vienadsanu trijsturis"
 }else{
   if(stringstring = "Vienadmalu trijsturis"){
   }else {
